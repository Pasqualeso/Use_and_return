...
class RegistrationFormAnnuncio(FlaskForm):
    ...
    provincia_annuncio = SelectField("Inserisci la provincia",
                                      choices=[("ag", "Agrigento"), ("al", "Alessandria"), ("an", "Ancona"),
                                               ("ao", "Aosta"), ("ar", "Arezzo"),
                                               ("ap", "Ascoli Piceno"),
                                               ...
                                               ("ci", "Carbonia - iglesias "), ("ce", "Caserta"),
                                               ...
                                               ("sp", "La spezia"), ("aq", "L'aquila"),
                                               ("lt", "Latina"), ("le", "Lecce"),
                                               ("lc", "Lecco"), ("li", "Livorno"), ("lo", "Lodi"), ("lu", "Lucca"),
                                               ("mc", "Macerata"),
                                               ...
                                               ("pa", "Palermo"), ("pr", "Parma"), ("pv", "Pavia"), ("pg", "Perugia"),
                                               ("pu", "Pesaro e Urbino"),
                                               ("pe", "Pescara"), ("pc", "Piacenza"),
                                               ("pi", "Pisa"), ("pt", "Pistoia"), ("pn", "Pordenone"),
                                               ("pz", "Potenza"), ("po", "Prato"),
                                               ("rg", "Ragusa"), ("ra", "Ravenna"), ("rc", "Reggio di Calabria"),
                                               ("re", "Reggio nell'Emilia"), ("ri", "Rieti"), ("rn", "Rimini"),
                                               ("rm", "Roma"), ("ro", "Rovigo"),
                                               ...
                                               ("vc", "Vercelli"), ("vr", "Verona"), ("vv", "ibo valentia"),
                                               ("vi", "Vicenza"), ("vt", "Viterbo")]
                                      , validators=[DataRequired()])

    via_annuncio = StringField("Inserisci la via", validators=[DataRequired()])
    cap_annuncio = StringField("Inserisci il cap", validators=[DataRequired()])
